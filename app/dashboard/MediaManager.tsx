...
const s = {
  ...
  head:{display:'flex',justifyContent:'space-between',alignItems:'center',gap:8}, h2:{margin:0,fontSize:15,fontWeight:800}, sub:{margin:'3px 0 0',fontSize:10,color:'#7890aa'},
  grid:{display:'grid',gridTemplateColumns:'repeat(3,minmax(0,1fr))',gap:10,marginTop:10}, card:{border:'1px solid #d7e1ed',borderRadius:9,overflow:'hidden',minWidth:0,background:'#fff'},
  cardHead:{padding:'9px 10px',borderBottom:'1px solid #e3eaf2',display:'flex',justifyContent:'space-between',alignItems:'center',gap:6}, body:{display:'grid',gridTemplateColumns:'150px minmax(0,1fr)',minHeight:320},
  folders:{borderRight:'1px solid #e3eaf2',background:'#fbfdff',padding:7,overflowY:'auto',maxHeight:420}, main:{minWidth:0,padding:9,display:'flex',flexDirection:'column',gap:8},
  button:{height:28,border:'1px solid #1769e8',background:'#1769e8',color:'#fff',borderRadius:6,padding:'0 9px',fontSize:10,fontWeight:800,cursor:'pointer'}, ghost:{height:28,border:'1px solid #bcd0e5',background:'#fff',color:'#315574',borderRadius:6,padding:'0 8px',fontSize:10,fontWeight:700,cursor:'pointer'},
  folder:{display:'flex',alignItems:'center',gap:4,width:'100%',border:0,background:'transparent',borderRadius:5,padding:'6px 4px',fontSize:10,color:'#365476',textAlign:'left',cursor:'pointer'},
