...
export default function PublicReadonly({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div style={{ position: "relative" }}>
      {children}
      <div aria-label="외부 공개용 보기 전용 화면" style={{ position: "absolute", inset: 0, zIndex: 20, cursor: "not-allowed", background: "transparent" }}>
